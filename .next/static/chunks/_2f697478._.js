                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        "data-oid": "irre.2o",
                                        "aria-label": "".concat(participant.isAbsent ? "Отметить как присутствующего" : "Отметить как отсутствующего", ": ").concat(participant.name)
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/components/ParticipantList.tsx",
                                        lineNumber: 52,
                                        columnNumber: 17
...
function EditListModal(param) {
    ...
    const handleSave = ()=>{
        ...
        if (uniqueNames.length !== validNames.length) {
            if ("object" !== "undefined" && !window.confirm("Есть повторяющиеся имена. Они будут удалены. Продолжить?")) {
                return;
            }
        }
        onSave(uniqueNames);
...
function Page() {
    ...
    const handleClearList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[handleClearList]": ()=>{
            if ("object" !== "undefined" && window.confirm("Вы уверены, что хотите очистить весь список?")) {
                setParticipants([]);
                setLastTwoHosts([]);
